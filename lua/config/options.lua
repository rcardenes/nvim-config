...
opt.conceallevel = 2            -- Hide & markup for bold and italic, but not markers with substitution
opt.confirm = true              -- Confirm to save changes before exiting modified buffer
opt.concealcursor = ""          -- Don't hid cursor line markup
opt.synmaxcol = 300             -- Syntax highlightint limit
...
opt.writebackup = true          -- Create backup before writing
opt.swapfile = true             -- Create swap file
